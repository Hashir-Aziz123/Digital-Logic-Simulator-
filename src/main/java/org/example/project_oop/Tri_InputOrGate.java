...
public class Tri_InputOrGate extends Gate
{
    Tri_InputOrGate(Connection input_line1 , Connection input_line2, Connection input_line3, Connection output_line)
    {
        // initialization
    ...
    public static void drawTri_InputOrGate(MouseEvent event , AnchorPane placement_area)
    {
        //getting cords
        ...
        Connection input_line1 = new Connection(x_cord-23,y_cord+14,x_cord-15,y_cord+14 , placement_area , false);
        input_line1.setStroke(Color.BLACK);
        input_line1.setStrokeWidth(7);
        Connection input_line2 = new Connection(x_cord-23,y_cord-14,x_cord-15,y_cord-14 , placement_area, false);
        input_line2.setStroke(Color.BLACK);
        input_line2.setStrokeWidth(7);
        Connection input_line3 = new Connection(x_cord-20,y_cord,x_cord-12,y_cord , placement_area, false);
        ...
        new Tri_InputOrGate( input_line1 , input_line2,input_line3 , output_line );


        boolean canDraw = isCanDraw(placement_area, curved_line1, curved_line2, input_line1, input_line2, input_line3 , output_line);

        // Add the gate components if no collision
        if (canDraw) {
            placement_area.getChildren().addAll(curved_line1 , curved_line2, input_line1, input_line2,input_line3 , output_line);
        } else {
            System.out.println("Can not place or gate on another or gate");
        }

        // adding event handling for dragging the gate around
        curved_line1.setOnMousePressed( e -> { dragGate( curved_line1 , curved_line2, input_line1 ,input_line2 ,input_line3 ,output_line , e , placement_area); });
        curved_line2.setOnMousePressed( e -> { dragGate  ( curved_line1 , curved_line2, input_line1 ,input_line2 ,input_line3 ,output_line , e , placement_area); });
        ...
        deleteButton.setOnAction(e -> {
            ...
            deleteGate(curved_line1 , curved_line2,input_line1 , input_line2 , input_line3 , output_line, placement_area);
        });
    ...
    private static boolean isCanDraw(AnchorPane placement_area, QuadCurve curved_line1, QuadCurve curved_line2, Connection input_line1, Connection input_line2,
                                     Connection input_line3, Connection output_line) {
    ...
    public static void deleteGate(QuadCurve curved_line1, QuadCurve curved_line2 , Connection input_line1, Connection input_line2 ,
                                  Connection input_line3, Connection output_line, AnchorPane placement_area)
    {
        if ( input_line1.getIsConnected() )
        {
        ...
        if ( input_line3.getIsConnected() )
        {
            System.out.println(input_line3.getConnectingWire());
        ...
        placement_area.getChildren().removeAll( curved_line1 , curved_line2, input_line1 , input_line2 , input_line3 , output_line);
