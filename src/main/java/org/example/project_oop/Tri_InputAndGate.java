...
public class Tri_InputAndGate extends Gate {


    Tri_InputAndGate(Connection input_line1 , Connection input_line2,Connection input_line3 , Connection output_line)
    {
        // initialization
        this.input_connection1 = input_line1;
        this.input_connection2 = input_line2;
        this.input_connection3 = input_line3;
        ...
        this.input_connection3.setCharacteristics(this,false);
        this.output_connection.setCharacteristics(this,true);
    }

    public static void drawTri_InputAndGate(MouseEvent event , AnchorPane placement_area)
    {

        System.out.println("Drawing the three input and gate");
        // getting cords
        ...
        Connection input_line1 = new Connection(x_cord-8,y_cord+14,x_cord-2,y_cord+14, placement_area,false);
        input_line1.setStroke(Color.BLACK);
        input_line1.setStrokeWidth(7);
        Connection input_line2 = new Connection(x_cord-8,y_cord-14,x_cord-2,y_cord-14, placement_area,false);
        input_line2.setStroke(Color.BLACK);
        input_line2.setStrokeWidth(7);
        Connection input_line3 = new Connection(x_cord-8,y_cord,x_cord-2,y_cord, placement_area,false);
        input_line3.setStroke(Color.BLACK);
        input_line3.setStrokeWidth(7);
        ...
        new Tri_InputAndGate( input_line1 , input_line2 , input_line3 ,  output_line );

        // Check for collisions with existing gates
        boolean canDraw = isCanDraw(placement_area, vertical_line, curved_line, input_line1, input_line2,input_line3, output_line);

        // Add the gate components if no collision
        if (canDraw)
        {
            placement_area.getChildren().addAll(vertical_line , curved_line, input_line1, input_line2, input_line3, output_line);
        }
        else
        {
        ...
        vertical_line.setOnMousePressed( e -> { dragGate( vertical_line , curved_line, input_line1 ,input_line2 , input_line3 ,output_line , e , placement_area); });
        curved_line.setOnMousePressed( e -> { dragGate  ( vertical_line , curved_line, input_line1 ,input_line2 , input_line3, output_line , e , placement_area ); });
        ...
        deleteButton.setOnAction(e -> {
            deleteGate(vertical_line , curved_line,input_line1 , input_line2 , input_line3 , output_line, placement_area);
        });
    ...
    private static boolean isCanDraw(AnchorPane placement_area, Line vertical_line, QuadCurve curved_line,
                                     Connection input_line1, Connection input_line2, Connection input_line3, Connection output_line)
    {
        ...
        for (Node gate : placement_area.getChildren())
        {
            if (gate instanceof QuadCurve || gate instanceof Line || gate instanceof Circle || gate instanceof Rectangle)
            {
                if (gate.getBoundsInParent().intersects(vertical_line.getBoundsInParent())
                        ...
                        || gate.getBoundsInParent().intersects(input_line3.getBoundsInParent())
    ...
    public void simulateGate() {
        System.out.println("Simulating three input and gate");
        this.getOutputConnection().getBoolValue().set(
                (       this.getInputConnection1().getBoolValue().get() )
                        ...
                        && ( this.getInputConnection3().getBoolValue().get() ) );
    }

    public static void dragGate( Line vertical_line , QuadCurve curved_line , Connection input_line1 ,
                                 Connection input_line2 , Connection input_line3 , Connection output_line , MouseEvent event1 , AnchorPane placementArea )
    {
        Node cause ;
        ...
        double orgTranslateXInp3    = input_line3.getTranslateX();
        double orgTranslateYInp3    = input_line3.getTranslateY();
        ...
        if( input_line3.getIsConnected() )
            input_line3.getConnectingWire().deleteWire( input_line3.getConnectingWire(), placementArea);
        ...
        cause.setOnMouseDragged( event2 ->
                {
                    ...
                    input_line3.setTranslateX( orgTranslateXInp3+ event2.getSceneX() - orgX);
                    input_line3.setTranslateY( orgTranslateYInp3+ event2.getSceneY() - orgY);

                    input_line3.updatePosition( input_line3.getStartX() , input_line3.getStartY() ,
                            input_line3.getEndX() , input_line3.getEndY() );
    ...
    public static void deleteGate(Line vertical_line , QuadCurve curved_line , Connection input_line1, Connection input_line2 , Connection input_line3 ,
                                  Connection output_line, AnchorPane placement_area)
    {
        ...
        if ( input_line3.getIsConnected() )
            input_line3.getConnectingWire().deleteWire( input_line3.getConnectingWire(), placement_area);
        if( output_line.getIsConnected() )
            output_line.getConnectingWire().deleteWire( output_line.getConnectingWire(), placement_area);
        placement_area.getChildren().removeAll(vertical_line , curved_line, input_line1 , input_line2 , input_line3 , output_line);
