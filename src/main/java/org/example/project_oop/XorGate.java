...
public class XorGate extends Gate
{
    ...
    XorGate(Connection input_line1 , Connection input_line2, Connection output_line)
    {
        // initialization
    ...
    public static void drawXorGate(MouseEvent event , AnchorPane placement_area)
    {
        ...
        //intializing the gate
        new XorGate(input_line1,input_line2,output_line);

        boolean canDraw = isCanDraw(placement_area, curved_line1, curved_line2, curved_line3, input_line1, input_line2, output_line);

        // Add the gate components if no collision
        if (canDraw) {
            placement_area.getChildren().addAll(curved_line1 , curved_line2, curved_line3, input_line1, input_line2, output_line);
        } else {
            System.out.println("Can not place xor gate on another xor gate");
        }

        // adding event handling for dragging the gate around
        curved_line1.setOnMousePressed( e -> { dragGate( curved_line1 , curved_line2, curved_line3, input_line1 ,input_line2 ,output_line , e , placement_area); });
        curved_line2.setOnMousePressed( e -> { dragGate  ( curved_line1 , curved_line2, curved_line3 , input_line1 ,input_line2 ,output_line , e , placement_area); });
        curved_line3.setOnMousePressed( e -> { dragGate  ( curved_line1 , curved_line2, curved_line3 , input_line1 ,input_line2 ,output_line , e , placement_area ); });
        ...
        deleteButton.setOnAction(e -> {
            deleteGate(curved_line1 , curved_line2 , curved_line3 ,input_line1 , input_line2 , output_line, placement_area);
        });
    ...
    private static boolean isCanDraw(AnchorPane placement_area, QuadCurve curved_line1, QuadCurve curved_line2, QuadCurve curved_line3, Connection input_line1, Connection input_line2, Connection output_line) {
    ...
    public void simulateGate() {
            System.out.println("Simulating xor gate");
    ...
    public static void dragGate( QuadCurve curved_line1 , QuadCurve curved_line2 , QuadCurve curved_line3 ,
    ...
    public static void deleteGate(QuadCurve curved_line1 , QuadCurve curved_line2 , QuadCurve curved_line3 , Connection input_line1, Connection input_line2 ,
                                  Connection output_line, AnchorPane placement_area)
    {
        ...
        placement_area.getChildren().removeAll(curved_line1 , curved_line2, curved_line3 , input_line1 , input_line2 , output_line);
